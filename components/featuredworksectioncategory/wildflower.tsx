...
export default function WildFlower() {
  ...
  return (
    <main className="wildflower-page">
      <style>{`
      ...
      <section className="hero" ref={heroRef}>
        <h1 className="hero-title">
          <span className="hero-title-inner">WILD FLOWER</span>
        </h1>
        <div className="hero-meta">
          ...
          <div>
            ...
            <p className="meta-value">Wild Flower</p>
          </div>
      ...
      <div className="laptop-mockup reveal">
        <img src="/assest/image/wildflower/wildflower1.png" alt="Armada" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", borderRadius: "20px" }} />
      </div>
      ...
      <section className="content-section reveal">
        ...
        <div className="section-body">
          <p>
            WildFlower, an eCommerce brand specializing in boho-inspired
            clothing and accessories, needed a visual identity that captured its
            free-spirited charm while maintaining a polished and modern appeal.
            The challenge lay in creating a cohesive design system that blended
            organic, whimsical elements with sleek functionality across digital and
            print platforms. This involved developing a nature-inspired color palette
            that balanced warmth with readability, selecting typography that
            conveyed both bohemian elegance and contemporary sophistication,
            and designing responsive layouts that preserved the brand's visual
            storytelling across all devices. Additionally, the product display system
            needed to highlight each item's uniqueness while maintaining a
            harmonious flow, all while building an emotional connection with a
            target audience seeking individuality, style, and the bohemian lifestyle.
            WildFlower's final design artfully bridges creativity and functionality,
            delivering an engaging and visually captivating brand experience.
          </p>
        </div>
      </section>
      ...
      <div className="reveal">
        <img src="/assest/image/wildflower/wildflower2.png" alt="Armada Construction" style={{ width: "100%", height: "auto", display: "block", borderRadius: "20px" }} />
      </div>
      ...
      >
        ...
        <div className="sticky-side">
          ...
          <p style={{
            ...
            The WildFlower logo embodies bohemian elegance through its clean, organic design 
            and refined typography. By combining simplicity with subtle sophistication, the logo 
            strikes a balance between understated beauty and bold visibility. Its minimalist approach 
            allows for versatility, ensuring it remains visually striking whether standing alone or 
            paired with additional design elements. The delicate letterforms evoke a sense of natural 
            grace, aligning seamlessly with WildFlower's ethos of authenticity, free-spirited charm, 
            and modern appeal.
          </p>
        </div>
        ...
        <div className="scrolling-side">
          <div style={{
            ...
            <img 
              src="/assest/image/wildflower/wildflower3.png" 
          ...
          <div style={{
            ...
            <img 
              src="/assest/image/wildflower/wildflower4.png" 
      ...
      <div className="reveal" style={{ marginTop: "10px" }}>
        <div className="brand-logo-display">
          <img src="/assest/image/wildflower/wildflower5.png" alt="Armada Construction" style={{ width: "100%", height: "auto", display: "block", borderRadius: "20px" }} />
        </div>
      </div>
      ...
      <div className="reveal" style={{ marginTop: "50px" }}>
        <div className="brand-logo-display">
          <img src="/assest/image/wildflower/wildflower6.png" alt="Armada Construction" style={{ width: "100%", height: "auto", display: "block", borderRadius: "20px" }} />
        </div>
      </div>
      ...
      >
        ...
        <div className="scrolling-side">
          <div style={{
            ...
            <img 
              src="/assest/image/wildflower/wildflower7.png" 
              alt="WildFlower Logo on White" 
              style={{ width: "100%", height: "auto", objectFit: "cover" }}
            />
          </div>
          ...
          <div style={{
            ...
            <img 
              src="/assest/image/wildflower/wildflower8.png" 
              alt="WildFlower Logo on Brown" 
              style={{ width: "100%", height: "auto", objectFit: "cover" }}
            />
          </div>
          ...
          <div style={{
            ...
            <img 
              src="/assest/image/wildflower/wildflower9.png" 
              alt="WildFlower Logo on Brown" 
              style={{ width: "100%", height: "auto", objectFit: "cover" }}
            />
          </div>
          ...
          <div style={{
            ...
            <img 
              src="/assest/image/wildflower/wildflower10.png" 
              alt="WildFlower Logo on Brown" 
              style={{ width: "100%", height: "auto", objectFit: "cover" }}
            />
          </div>
          ...
          <div style={{
            ...
            <img 
              src="/assest/image/wildflower/wildflower11.png" 
              alt="WildFlower Logo on Brown" 
              style={{ width: "100%", height: "auto", objectFit: "cover" }}
            />
          </div>
        ...
        <div className="sticky-side">
          ...
          <p style={{
            ...
            We created a versatile brand guide and cohesive
            stationery designs, ensuring brand consistency across
            packaging, invoices, and customer correspondence,
            enhancing brand recall at every touchpoint.
          </p>
        </div>
      </section>
