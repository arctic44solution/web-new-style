...
export default function ZenithVr() {
    ...
    <main className="zenithvr-page">
      ...
      <section className="hero" ref={heroRef}>
        <h1 className="hero-title">
          <span className="hero-title-inner">ZENITH VR</span>
        </h1>
        <div className="hero-meta">
          <div>
            <p className="meta-label">Year</p>
            <p className="meta-value">2024</p>
          </div>
          <div>
            <p className="meta-label">Client</p>
            <p className="meta-value">Zenith VR</p>
          </div>
      ...
      <div className="laptop-mockup reveal">
        <img src="/assest/image/zenithvr/zenithvr1.png" alt="Armada" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", borderRadius: "20px" }} />
      </div>
      ...
      <section className="content-section reveal">
        ...
        <div className="section-body">
          <p>
            Zenith, a cutting-edge VR headset brand, needed a cohesive identity
            that reflected innovation and immersion. Their vision was to resonate
            with tech-savvy users while conveying the promise of new
            experiences.
            We crafted a sleek logo featuring a star within an eye, symbolizing
            Zenith’s peak and visionary approach. The vibrant blue palette reflects
            trust and technological advancement. Alongside the logo, we
            developed comprehensive brand guidelines and striking packaging, all
            aligned with the tagline: Step into a new reality.
          </p>
        </div>
      </section>
      ...
      <div className="brand-logo-image">
        <div className="brand-logo-display">
            <img src="/assest/image/zenithvr/zenithvr2.png" alt="ZenithVR Logo"/>
        </div>
      </div>

      <div className="brand-logo-image" style={{ marginTop: "60px" }}>
        <div className="brand-logo-display">
            <img src="/assest/image/zenithvr/zenithvr3.png" alt="Zenith VR Logo"/>
        </div>
      </div>
      ...
      >
        ...
        <div className="sticky-side">
          ...
          <p style={{
            ...
            The Zenith logo embodies the brand’s innovative spirit and
            vision. The eye symbolizes exploration and perspective,
            while the star within represents Zenith’s peak—a place of
            discovery and limitless potential. The vibrant blue hue
            conveys trust, technology, and a sense of futuristic
            innovation.

            This thoughtfully crafted design aligns seamlessly with the
            brand’s mission to invite users to Step into a new reality.
            It’s a visual identity that captures the essence of
            immersive experiences, positioning Zenith as a leader in
            VR innovation.
          </p>
        </div>
        ...
        <div className="scrolling-side">
          <div style={{
            ...
            <img 
              src="/assest/image/zenithvr/zenithvr4.png" 
              alt="Zenith VR Logo on White" 
          ...
          <div style={{
            ...
            <img 
              src="/assest/image/zenithvr/zenithvr5.png" 
              alt="Zenith VR Logo on Brown" 
              style={{ width: "100%", height: "auto", objectFit: "cover" }}
            />
          </div>
          ...
          <div style={{
            ...
            <img 
              src="/assest/image/zenithvr/zenithvr6.png" 
              alt="Zenith VR Logo on Blue" 
              style={{ width: "100%", height: "auto", objectFit: "cover" }}
            />
          </div>
        </div>
      ...
      <div className="brand-logo-image">
        <div className="brand-logo-display">
            <img src="/assest/image/zenithvr/zenithvr7.png" alt="ZenithVR Logo"/>
        </div>
      </div>

      <div className="brand-logo-image" style={{ marginTop: "60px" }}>
        <div className="brand-logo-display">
            <img src="/assest/image/zenithvr/zenithvr8.png" alt="Zenith VR Logo"/>
        </div>
      </div>

      {/* MORE WORK SECTION */}
      <section className="more-work-section" ref={containerRef} onMouseMove={handleMouseMove} style={{ marginTop: "40px" }}>
        <div className="more-work-inner">
          ...
          <div className="work-list">
            ...
            <div 
              className="work-item"
              onMouseEnter={() => setActiveImage("/assest/image/mayfield/mayfield.png")}
              onMouseLeave={() => setActiveImage(null)}
            >
              <span className="work-num">02</span>
              <span className="work-name">MayField</span>
