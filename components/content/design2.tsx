      ...
      <div className="page-wrapper">
        ...
        <div className="right-content">
          <h1 className="d2-headline">
            Unifying Vision, Strategy, and<br />
            Execution Into Cohesive Experiences
          </h1>

          <p className="d2-description">
            I provide brand-first creative direction rooted in vision and clarity—uncovering a brand's "why" and aligning design, voice, and
            experience into cohesive systems. I connect the big picture across visual, written, audio, and motion to ensure every
          ...
          <ul className="services-list">
            {services.map((service) => (
              ...
              >
                ...
                <span className="d2-service-title">{service.title}</span>
                <span className="d2-service-number">{service.id}</span>
              </li>
            ))}
          </ul>
